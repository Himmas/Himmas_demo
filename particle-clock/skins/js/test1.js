...
window.onload=function test1(){
	windows_width = $(document.body).width();
...
//更新时间&&判断更新部分添加小球方法
function update(){
	var test1_time=new Date();
	var hours=test1_time.getHours();
	var minutes=test1_time.getMinutes();
	var seconds=test1_time.getSeconds();
	
	var now = new Date(test1_time.getTime() - 1000);
